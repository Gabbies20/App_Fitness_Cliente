...
urlpatterns = [
    ...
    path('entrenamiento/editar/descripcion/<int:entrenamiento_id>',views.entrenamiento_editar_descripcion,name='entrenamiento_editar_descripcion'),
    ...
    path('ejercicios/busqueda/musculos',views.musculos_busqueda_simple,name="busqueda-musculos"),
